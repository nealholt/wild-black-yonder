...
Create a test object for setClosestSprites similar to the one for profiling.
Also you will want to profile setClosestSprites.
...
The problem is that collision avoidance still sucks.
