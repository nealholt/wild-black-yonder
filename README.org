...
ship.goTo is ignoring its arguments. You need to change this. Also, you need to generally read through the code and figure out what can be cleaned and improved. The appropriate files are open.
