...
** nodeManager.py should store warps, planets, and fuel depots
Largely done. Can you clean up and make this code more efficient?
...
** capital ship bug
go down and to the left. Image appears but no ship is present. Odd.
