...
An easy way to do battles with 2 teams is to have a global red team object and a global blue team object and have any ships in these objects in the state of attacking go after a randomly selected ship in the other list until that other is destroyed.

Then just by default put the player in team blue and the enemy in team red.
For the escort mission you can also put the npc in team blue.
