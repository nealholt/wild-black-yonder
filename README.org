...
Debug, then:
0. fix formatting of node and faction attributes in menus. http://stackoverflow.com/questions/455612/python-limiting-floats-to-two-decimal-points
...
3. grep for TODO LEFT OFF HERE
4. need to be able to view my ship stats when no other ships are equipped
** pygame executable
