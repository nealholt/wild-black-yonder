...
If you set far travel up and to the left and then you fly through the warp point twice up and to the left, the health bar will be there.

Don't shoot anything. It will be there with or without flip turned on.
...
I think that an enemy is dieing and the health bar is lingering some how.
