...
7. make pirate tech level scale with distance from player start. Make it all more game-like.
...
8. implementing save and load next could be really helpful for debugging.
** pygame executable
