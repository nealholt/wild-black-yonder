...
def getMissionArray():
	...
	temp.addWinConsequence(0, 0, 1, faction_index)
	temp.addWinConsequence(globalvars.node_weapon_tech_index, globalvars.node_engine_tech_index, 1, node_index)
	temp.addLoseConsequence(0, 0, -1, faction_index)
	missions.append(temp)
