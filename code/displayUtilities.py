...
import colors
import time
from geometry import rotateAngle, distance, translate, angleFromPosition
...
def displayShipLoc(ship):
	string = "Player X,Y: "+str(ship.rect.centerx)+','+str(ship.rect.centery)+\
...
class TimeTrialAssistant():
	...
	def update(self, offset):
		...
		if dtt < 40:
			...
			writeTextToScreen(string='TIME TRIAL COMPLETED', font_size=64,\
				pos=(game.WIDTH/3, game.HEIGHT/2))
			pygame.display.flip()
