...
ship_class_names = ['Worthless', 'Junk', 'Scrap', 'Cheap', 'Okay', 'Cool', 'Hot', 'Noble', 'Peerless', 'Kingly', 'Emperor', 'Tyrant', 'God-Emperor','Transcendent']
...
def getShipAdj(health_index, collision_safe_index):
	if collision_safe_index == 2:
...
class Ship(PhysicalObject):
	def __init__(self, centerx=0, centery=0, image_name='default'):
		...
		self.collision_safe_index = rd.randint(0, len(collision_safe_classes)-1)
