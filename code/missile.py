...
missile_class_names = ['Worthless', 'Scrap', 'Cheap', 'Okay', 'Cool', 'Hot', 'Noble', 'King', 'Emperor', 'Tyrant', 'Transcendent']
...
class MissileLauncher():
	...
	def shoot(self):
		tempmissile = Missile(self.shooter, self.speed, self.turn_rate, self.damage, self.longevity)
	...
	def getMissileClass(self):
		'''Current range of Missile ratings solely based on the numbers in this method is -10 to 22 inclusive.
