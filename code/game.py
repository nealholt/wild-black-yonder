...
def run():
	...
	while running:
		...
		#Draw intangibles
		#TODO drawThoseOnScreen(globalvars.intangibles, offset)
		#Draw tangibles
		#TODO drawThoseOnScreen(globalvars.tangibles.sprites(), offset)
		...
		if not globalvars.player.isDead():
			...
			#TODO
			dirty_rects.append(globalvars.player.rect)
		else:
